class TodosController < ApplicationController
  ...
  def mytodo
    # @todos = Todo.where(id: current_user.id).all
    @todos = current_user.todos.paginate(page: params[:page], per_page: 8)
  ...
  def create
    ...
    respond_to do |format|
      if @todo.save
        format.html { redirect_to '/mytodo', notice: "Todo was successfully created." }
    ...
    @todo.user_id = current_user.id
      respond_to do |format|
        if @todo.update(todo_params)
          format.html { redirect_to '/mytodo', notice: "Todo was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to '/mytodo', notice: "Todo was successfully destroyed." }
